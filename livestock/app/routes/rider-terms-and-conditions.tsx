import type { Route } from "./+types/rider-terms-and-conditions";
import { SITE_URL } from "../seoTopics";

export const links: Route.LinksFunction = () => [
  { rel: "canonical", href: `${SITE_URL}/rider-terms-and-conditions` },
];

export function meta({}: Route.MetaArgs) {
  return [
    { title: "Rider Terms & Conditions | S.K Rider" },
    { name: "description", content: "Read the S.K Rider terms and conditions for delivery partners using the rider app and delivery services." },
    { name: "robots", content: "index, follow" },
  ];
}

export default function RiderTermsAndConditions() {
  return (
    <div className="policy-page">
      <div className="policy-inner">
        ...
        <p className="policy-updated">App Name – S.K Rider</p>
        ...
        <p className="policy-lead">
          ...
          service for the delivery of SULEMAN KHAN LIVESTOCK PVT LTD products including but not limited to
          fresh meat and these are the terms and conditions governing your access and use of S.K Rider along
          with its related sub-domains, sites, mobile app, services and tools (the "Site"). By using the
          Mobile Application or Site (as the case may be), you hereby accept these terms and conditions
          (including the linked information herein) and represent that you agree to comply with these terms
          and conditions (the "User Agreement"). This User Agreement is deemed effective upon your use of the
          Mobile Application or Site (as the case may be) which signifies your acceptance of these terms. If
          you do not agree to be bound by this User Agreement, please do not access, register with or use this Site.
          This Site is owned and operated by S.K Rider.
        </p>

        <p className="policy-lead">
          The S.K Rider reserves the right to change, modify, add, or remove portions of these Terms and
          Conditions at any time without any prior notification. Changes will be effective when posted on the
          Site with no other notice provided. Please check these Terms and Conditions regularly for updates.
          Your continued use of the App/Site following the posting of changes to Terms and Conditions of use
        ...
        <section className="policy-section">
          ...
          <p>
            The Rider App is intended solely for registered delivery partners ("Riders") of S.K Rider. The App enables
            Riders to receive, accept, manage and complete delivery assignments for meat and related products sold
            through S.K Livestock customer application. The Rider App is not a marketplace for buying or selling products.
          </p>
        </section>
        ...
        <section className="policy-section">
          <h2>4. S.K Rider&apos;s Rights</h2>
          <p>S.K Rider is entitled to the following:</p>
          <ul>
        ...
        <section className="policy-section">
          ...
          <p>
            Riders are independent contractors and not employees of SULEMAN KHAN LIVESTOCK PVT LTD. No entitlement to gratuity,
            leave, EOBI, medical or other employee benefits unless required by law.
          </p>
        </section>
        ...
        <section className="policy-section">
          <h2>8. Privacy</h2>
          <p>
            Please review our Privacy Agreement, which also governs your visit to the App/Site. The personal information / data provided
        ...
        <section className="policy-section">
          ...
          <p>
            User must not use the app or website in any way that causes, or is likely to cause, the app or Site or access to it to be
            interrupted, damaged or impaired in any way. You must not engage in activities that could harm or potentially harm the Site,
            its employees, officers, representatives, stakeholders or any other party directly or indirectly associated with the Site or
            access to it to be interrupted, damaged or impaired in any way. You understand that you, and not us, are responsible for all
            electronic communications and content sent from your device to us and you must use the platform, app or Site for lawful purposes only.
            You are strictly prohibited from using the Site:
          </p>
          <ul>
        ...
        <section className="policy-section">
          ...
          <div className="policy-contact">
            ...
            <p><strong>Phone:</strong> <a href="tel:+923000022755">+92 300 0022755</a></p>
